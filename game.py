    ...
    while paused:
        ...
        if paused:
            ...
            if button_rect.collidepoint(pygame.mouse.get_pos()) and pygame.mouse.get_pressed()[0]:
                ...
                minus_button_text = font.render('-', True, (100, 100, 255))
